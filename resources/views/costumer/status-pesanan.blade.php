          ...
          <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
              <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 px-5 py-4">
                  ...
                  <div class="ml-3 mr-auto">
                      ...
                      <div 
                        class="flex text-slate-500 truncate text-xs mt-0.5"> 
                        <a 
                          class="text-slate-500 inline-block truncate" 
                          >{{ $pesanan->costumer->email }}
                        </a> 
                        <span class="mx-1">•</span> {{ $pesanan->created_at->diffForHumans() }} </div>
                  </div>
              ...
              <div class="p-5">
                  <div class="h-40 2xl:h-56 image-fit">
                    @if ($pesanan->vehicle->gambar)
                      <img alt="fatir huhahuha" class="rounded-md" src="{{ asset('storage/' . $pesanan->vehicle->gambar) }}">
                    @else
                      <img alt="fatir huhahuha" class="rounded-md" src="{{ asset('dist/images/preview-6.jpg') }}">
                    @endif
                  </div>
                  <div class="text-slate-600 dark:text-slate-500 mt-5">
                    <div 
                        class="flex items-center"><i data-lucide="link" class="w-4 h-4 mr-2"></i> 
                    ...
                    <div class="flex items-center mt-2 space-x-2"> 
                      ...
                      <span 
                        ...
                        {{ucwords('menunggu konfirmasi driver')}}
                      </span>
